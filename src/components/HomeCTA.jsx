...
const HomeCTA = () => {
  return (
    <section className='my-28 bg-[#2C343E] rounded-2xl p-8 pt-28 flex flex-col shadow-md  items-center text-white mb-[17rem]  relative lg:h-[580px]'>
      <h2 className='font-[Fraunces] mb-3 text-4xl font-extrabold text-center' data-aos="textAnimation"  data-aos-duration="1200" >Why choose us?</h2>
      <p className='lg:w-[500px] mb-9 text-center' data-aos="fade-up"  >A large part of our role is choosing which particular coffees will be featured in our range. This means working closely with the best coffee growers to give you a more impactful experience on every level.</p>
      <div className="choose__us flex-col lg:flex-row lg:absolute bottom-[-130px]  flex w-[100%] justify-center gap-[2rem]">
        <div data-aos="fade-up"  className="  drop-shadow-lg choose__us-card flex sm:flex-col sm:p-9 sm:text-center md:flex-row justify-center w-full lg:flex-col max-w-full lg:w-[350px] bg-[#0E8784] p-4 rounded-lg px-8 md:text-left  items-center lg:text-center gap-9 lg:h-[350px] " >

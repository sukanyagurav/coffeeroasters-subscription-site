  ...
  return (
    <>
        ...
        <article className='flex justify-between gap-[5rem] my-[8rem] max-w-[85%] mx-auto items-center text-center lg:text-left  flex-col lg:flex-row'>
            <img data-aos="fade-right" src={commitment} className='rounded-xl' alt="commitment image" />
            <div className="commitment" data-aos="fade-left">
        ...
        <article className='flex bg-[#2C343E] h-[500px] justify-end lg:justify-between md:h-[420px] rounded-lg lg:gap-[5rem] mt-[20rem]  lg:p-12 items-center text-center lg:text-left  flex-col lg:flex-row relative'>
            ...
            <div data-aos="fade-left" className="quality p-6 lg:mt-0 flex-[0.5]  lg:w-[550px] lg:flex-[0.6] order-2 lg:order-1">
            ...
            <div   data-aos="fade-right" className='quality__bg flex-[0.5] order-1 top-[-150px]  lg:order-2 lg:relative lg:right-[4%] lg:top-[-170px]'>
        ...
        <section className='w-[90%] mx-auto my-[12rem] text-center lg:text-left'>
            ...
            <div className="flex items-center justify-between gap-[1rem] flex-col lg:flex-row">
                <div className='w-[100%] md:w-[25%]' >
                    <img data-aos="zoom-in-up" src={uk} alt="uk" className='w-[80px] mx-auto lg:mx-0 h-[80px] mb-5 '/>
                ...
                <div className='w-[100%] md:w-[25%]'>
                    <img data-aos="zoom-in-up" src={canada} alt="uk" className='w-[80px] mx-auto lg:mx-0 h-[80px] mb-5 ' />
                    <div className="flex  flex-col gap-5" data-aos="fade-up">
